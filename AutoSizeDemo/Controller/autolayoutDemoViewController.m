...
@interface autolayoutDemoViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    static labelAutolayoutTableViewCell *cell = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        cell = [tableView dequeueReusableCellWithIdentifier:@"labelAutolayoutTableViewCell"];
    });
